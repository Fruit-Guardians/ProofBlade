...
import { buildSchedulingContext, handleIntentsCommand } from '../src/commands/intents.js';
...
test('CLI scheduling context counts proposed intents toward the concurrency limit', () => {
  const snapshot = {
