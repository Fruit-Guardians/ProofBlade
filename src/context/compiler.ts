...
export class ContextCompiler {
  public build(input: ContextBuildInput): ContextBuildOutput {
    ...
    const layerTokens = { L0: estimateTokens(l0), L1: estimateTokens(l1), L2: estimateTokens(l2), L3: estimateTokens(l3), L4: estimateTokens(l4.map((m) => m.content).join("\n")), L5: estimateTokens(l5) };
