 ...
 */
const CODING_TOOL_CONTRACT_HASH = "cdfbe4de6dfc30e42fe0762f61ac5990ca7f30a6ba7c77cf8fdfb777c0d68ddf";
...
test("coding provider tools keep stable Skill, Capability, and MCP proxy contracts", () => {
  ...
  assert.deepEqual(snapshot.map((tool) => tool.name), ["read", "bash", "edit", "write", "glob", "grep", "update_phase", "verify_result", "evidence", "evidence_record", "load_skill", "capability", "mcp_call", "shell_background", "shell_job", "pwn_open", "pwn_send", "pwn_recv", "pwn_signal", "pwn_close", "pwn_list", "pwn_workflow", "pwn_cyclic", "pwn_crash_analyze", "pwn_record_leak", "pwn_derive_base", "pwn_record_primitive", "pwn_identify_libc", "pwn_rop_chain", "pwn_fmtstr", "pwn_heap_calc", "pwn_reproduce"]);
