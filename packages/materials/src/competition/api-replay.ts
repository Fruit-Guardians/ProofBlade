...
export async function replayCompetitionApiScript(api: Pick<CompetitionApiJournal, "listChallenges" | "getChallenge" | "startEnvironment" | "submitFlag" | "stopEnvironment">, steps: readonly CompetitionApiReplayStep[]): Promise<CompetitionApiReplayResult[]> {
