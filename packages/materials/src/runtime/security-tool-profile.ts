...
const ACTION_BUNDLES: Record<SecurityDomain, ActionBundle[]> = {
  pwn: [
    ...
    },
    {
      ...
      toolNames: ["read", "bash", "pwn_recv", "pwn_crash_analyze", "pwn_record_leak", "pwn_record_primitive", "capability", "mcp_call"],
    ...
    },
    {
      ...
      toolNames: ["read", "bash", "pwn_list", "pwn_cyclic", "pwn_derive_base", "pwn_record_primitive"],
    ...
    },
    {
      ...
      toolNames: ["pwn_send", "pwn_recv", "pwn_signal", "pwn_list", "pwn_cyclic", "pwn_crash_analyze", "pwn_record_leak", "pwn_derive_base", "read", "bash"],
      capabilityIds: ["pwn.tube"],
