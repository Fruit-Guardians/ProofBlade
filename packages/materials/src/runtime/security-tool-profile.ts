...
const FIRST_ACTION_PLANS: Record<SecurityDomain, FirstActionPlan> = {
  ...
  pwn: { id: "pwn-binary-or-tube", allowedToolNames: ["read", "bash", "capability", "pwn_open", "pwn_recv", "pwn_workflow"], maxCalls: 2 },
  ...
  pwn: [
    {
      ...
      toolNames: ["read", "bash", "capability", "pwn_open", "pwn_recv", "pwn_workflow"],
    ...
    },
    {
      ...
      toolNames: ["read", "bash", "pwn_recv", "pwn_crash_analyze", "pwn_record_leak", "pwn_record_primitive", "pwn_workflow", "capability", "mcp_call"],
    ...
    },
    {
      ...
      toolNames: ["read", "bash", "pwn_list", "pwn_workflow", "pwn_cyclic", "pwn_derive_base", "pwn_record_primitive", "pwn_identify_libc", "pwn_rop_chain", "pwn_fmtstr", "pwn_heap_calc"],
    ...
    },
    {
      ...
      toolNames: ["pwn_send", "pwn_recv", "pwn_signal", "pwn_list", "pwn_workflow", "pwn_cyclic", "pwn_crash_analyze", "pwn_record_leak", "pwn_derive_base", "pwn_identify_libc", "pwn_rop_chain", "pwn_fmtstr", "pwn_heap_calc", "read", "bash"],
      capabilityIds: ["pwn.tube"],
    ...
    },
    {
      ...
      preconditions: ["The pwn_workflow view reports a route-specific basis and a task-owned pwn verifier contract exists."],
...
const PROFILE_DATA: Record<SecurityDomain, Omit<SecurityToolProfile, "id" | "actionBundles">> = {
  ...
  pwn: {
    targetKind: "pwn",
    firstAction: "Read pwn_workflow, then run file/checksec or the prepared proofblade.binary identify capability and one bounded protocol probe (pwn_open plus pwn_recv when a tube is ready); persist architecture, mitigations, prompt anchor, and interaction state before crafting a payload. For a crash, pass bounded GDB/pwndbg output to pwn_crash_analyze; use pwn_cyclic for offsets, then record exact leaks and base formulas with pwn_record_leak/pwn_derive_base. Identify libcs with pwn_identify_libc, assemble chains with pwn_rop_chain, and build format-string writes with pwn_fmtstr instead of packing bytes by hand. Treat these as hypotheses until pwn_reproduce succeeds.",
