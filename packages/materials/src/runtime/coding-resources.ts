...
export const CODING_PWN_TOOL_NAMES = ["pwn_open", "pwn_send", "pwn_recv", "pwn_signal", "pwn_close", "pwn_list", "pwn_workflow", "pwn_cyclic", "pwn_crash_analyze", "pwn_record_leak", "pwn_derive_base", "pwn_record_primitive", "pwn_identify_libc", "pwn_rop_chain", "pwn_fmtstr", "pwn_heap_calc", "pwn_reproduce"] as const;
 ...
 * prepared tool remains available in every phase. Pwn-specific sequencing is
 * exposed by pwn_workflow and remains generation-bound.
 */
